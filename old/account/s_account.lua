function login(player, username, password, save)
    if(username and password) then
        ...
        if(account ~= false) then
            ...
            exports.notify:notifyPlayer(player, "Login", "Server", "Login successful", 2, false)
            ...
            exports.notify:notifyPlayer(player, "Login", "Server", "Username or Password wrong", 3, false)
        end
    else
        exports.notify:notifyPlayer(player, "Please type your username and password", 0, false)
    end
end
